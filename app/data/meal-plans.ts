...
export const MEALS: MealPlan = {
  breakfast: {
    high_protein: [
      ...
      { name: 'Oats Dosa with Coconut Chutney', calories: 300, protein: 10, tags: ['south_indian', 'vegetarian'], prepTime: 10, cookTime: 20 },
      { name: 'Quinoa Upma', calories: 280, protein: 12, tags: ['fusion', 'vegetarian'], prepTime: 15, cookTime: 15 }
    ],
    low_carb: [
      ...
      { name: 'Grilled Halloumi with Avocado', calories: 250, protein: 15, tags: ['keto', 'vegetarian'], prepTime: 15, cookTime: 10 }
    ],
    balanced: [
      ...
      { name: 'Vegetable Oats Porridge', calories: 280, protein: 8, tags: ['fusion', 'vegetarian'], prepTime: 10, cookTime: 10 }
    ]
  },
  lunch: {
    high_protein: [
      ...
      { name: 'Thai Basil Chicken with Brown Rice', calories: 430, protein: 34, tags: ['fusion'], prepTime: 20, cookTime: 30 },
      { name: 'Mutton Rogan Josh with Bajra Roti', calories: 480, protein: 32, tags: ['north_indian'], prepTime: 25, cookTime: 40 }
    ],
    low_carb: [
